...
export const JOURNEY = [
  {
    ...
    num: 1,
    title: "얼마짜리 집이 가능한가",
    blurb: "생애최초·소득·목표 집값으로 대출 가능액과 필요 현금부터 파악해요.",
    nodeIds: [
      "first_time_buyer",
      "annual_income",
      "target_price",
  ...
  },
  {
    ...
    num: 2,
    title: "종잣돈 계획",
    blurb: "지금 돈과 월 저축으로 부족분·달성 기간을 보고, 없으면 청약통장부터 만들어요.",
    nodeIds: ["seed_savings", "monthly_saving", "incidental_costs", "saving_gap", "time_to_buy", "subscription_account"],
    todo: [
      "실제 동원 가능한 현금 정리 (전세보증금은 빼기)",
      "매달 확실히 저축하는 금액 정하기",
      "청약통장 개설 — 없다면 오늘",
    ],
    housePart: "walls",
