...
export const JOURNEY = [
  ...
  },
  {
    ...
    todo: [
      "매달 확실히 저축하는 금액 정하기",
      "청약통장 개설 — 없다면 오늘",
      "가족에게 빌린 돈이 있다면 차용증 + 이체내역 남기기 (나중에 자금출처 조사에 필요)",
    ],
    housePart: "walls",
    area: "seed",
    color: "#059669",
  ...
  },
  {
    ...
    todo: [
      "3개 이상 은행 금리 비교 + 정책상품(디딤돌·보금자리 등) 확인",
      "카드론·학자금·자동차 할부 등 기존 대출 정리",
      "우대금리 조건(급여이체·카드사용·자동이체·예적금 등) 확인",
      "매매가 말고 은행 담보평가액(감정가)도 확인 — 대출 한도는 이 기준",
      "중도상환수수료 확인 — 나중에 갈아타거나 미리 갚을 계획이면 중요",
  ...
  },
  {
    ...
    todo: [
      "계약서 쓰기 전에 은행에 잔금일 대출 실행 가능 여부·필요 서류 확인",
