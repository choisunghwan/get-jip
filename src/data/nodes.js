...
export const NODES = [
  ...
  },
  {
    ...
    area: "loan",
    label: "주담대 금리",
    desc: "'주택담보대출'(집을 담보로 잡고 받는 대출) 이자율이에요. 금리가 안 변하는 '고정'과, 시장에 따라 바뀌는 '변동'이 있고, 은행마다 달라요. 이 %가 매달 갚는 돈을 정해요.",
    tip: "0.3%p 차이여도 30년 갚으면 수천만원 차이가 나요. 최소 3개 은행은 비교하고, 정부가 지원하는 저금리 상품(보금자리론 등)도 확인하세요.",
  },
  {
    id: "annual_income",
    area: "loan",
